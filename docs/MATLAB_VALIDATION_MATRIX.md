...
Separate newer evidence on 2026-09-13: S1 path/security checks and M6.3 fixed
tiled layouts were tested with MATLAB R2026a Update 5 on Windows. M6.3 includes
26 native cases, three native-workflow cases using Linux LuaLaTeX through a local
