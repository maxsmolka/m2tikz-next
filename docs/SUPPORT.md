...
| **API-freeze candidate / internal** | The pre-1.0 public workflows, profile options and manifest schema 1 follow [API.md](API.md); breaking changes are exceptional. FigureIR v2, JSON helpers and `m2t2.*` remain internal implementation interfaces. |
